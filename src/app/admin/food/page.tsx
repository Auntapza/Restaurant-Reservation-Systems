        ...
        <>
            <div className="grid grid-cols-2">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <select name="" id="" className="rounded shadow w-2/3 p-2 text-2xl">
            ...
            <div className="mt-3 bg-white rounded-lg shadows size-full grid grid-cols-4 p-5 gap-4">
                {foodCardData.map((e, index) => (<FoodCard data={e} key={index}/>))}
            </div>
        </>
    )
}
...
const FoodCard = ({ data }: {
    ...
    return (
        <div className="border border-black rounded shadow overflow-hidden">
            <Image src={dummyImage} alt="" className="w-full object-cover h-52"/>
            ...
            <div className="grid grid-cols-2 px-3 my-6 gap-3">
                <Link href={'./food/edit'} className="bg-white text-orange-500 border-2 border-orange-500 hover:text-white
