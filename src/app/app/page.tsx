...
function Mainpage() {
    ...
    const FoodCard = () => {
        return (
            <div className='bg-white border border-black rounded-md shadow-xl p-5 grid gap-y-2 hover:scale-110 transition hover:border-orange-500'>
    ...
    return (
        <>
            <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M51.7781 3.9375V39.7688H38.5874V17.1281C38.5874 13.6298 39.9771 10.2746 42.4508 7.80092C44.9245 5.3272 48.2797 3.9375 51.7781 3.9375Z" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M44.0999 39.5719H51.778V56.1094C51.778 57.1015 51.3839 58.0529 50.6824 58.7544C49.9809 59.4559 49.0294 59.85 48.0374 59.85H47.8405C46.8485 59.85 45.897 59.4559 45.1955 58.7544C44.494 58.0529 44.0999 57.1015 44.0999 56.1094V39.5719Z" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M18.8999 59.85C17.699 59.85 16.5473 59.3729 15.6981 58.5238C14.8489 57.6746 14.3718 56.5228 14.3718 55.3219L16.3406 30.7125H21.6562L23.6249 55.3219C23.6255 55.9335 23.5022 56.5388 23.2624 57.1015C23.0227 57.6641 22.6714 58.1723 22.2298 58.5954C21.7883 59.0186 21.2656 59.3479 20.6933 59.5635C20.121 59.7792 19.5109 59.8766 18.8999 59.85Z" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M27.7594 21.8531C27.4401 24.0007 26.36 25.9621 24.7158 27.3799C23.0716 28.7978 20.9727 29.5778 18.8016 29.5778C16.6305 29.5778 14.5316 28.7978 12.8874 27.3799C11.2431 25.9621 10.163 24.0007 9.84375 21.8531H27.7594Z" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M9.84375 5.51248V21.8531" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M18.7031 5.51248V21.4594" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
                <path d="M27.7593 5.51248V21.8531" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className='group-hover:stroke-orange-600 transition'/>
            </svg>
        </>
    )
}
...
function Drink() {
    return (
        <>
            <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.5938 38.7844L45.2812 15.9469H5.90625L25.5938 38.7844ZM25.5938 38.7844L45.2812 15.9469H5.90625L25.5938 38.7844Z" stroke="black" className='group-hover:stroke-orange-600 transition' strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M25.5938 38.7844V56.5032" stroke="black" className='group-hover:stroke-orange-600 transition' strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.6001 56.5032H38.5876" stroke="black" className='group-hover:stroke-orange-600 transition' strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M17.9158 29.1375H33.272" stroke="black" className='group-hover:stroke-orange-600 transition' strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M35.2407 15.9469C35.2407 13.961 35.8296 12.0198 36.9329 10.3686C38.0361 8.71746 39.6043 7.43051 41.439 6.67056C43.2737 5.9106 45.2925 5.71176 47.2402 6.09918C49.1879 6.4866 50.9769 7.44292 52.3811 8.84713C53.7853 10.2513 54.7416 12.0404 55.129 13.9881C55.5164 15.9358 55.3176 17.9546 54.5576 19.7893C53.7977 21.624 52.5108 23.1921 50.8596 24.2954C49.2085 25.3987 47.2671 25.9875 45.2813 25.9875C42.8721 25.9756 40.5545 25.0626 38.7844 23.4281" stroke="black" className='group-hover:stroke-orange-600 transition' strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </>
    )
}
